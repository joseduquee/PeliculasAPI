...
namespace PeliculasApi.Controllers
{
    ...
    public class ActoresController : ControllerBase
    {
        ...
        public ActoresController(ApplicationDbContext context, IMapper mapper, IAlmacenadorArchivos almacenador, IAlmacenadorArchivos almacenadorArchivos)
        {
            this.context = context;
            this.mapper = mapper;
            this.almacenadorArchivos = almacenador;
        }
        ...
        public async Task<ActionResult<List<PeliculaActorDTO>>> BuscarPorNombre([FromBody] string nombre)
        {
            ...
            return await context.Actores.Where(x => x.Nombre.Contains(nombre))
                ...
                .Take(5).ToListAsync(); //mapeo manual
        }
